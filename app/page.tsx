...
export default function Hero() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <main className="container mx-auto px-2 flex flex-col items-center text-center">
        <Badge variant="secondary" className="mb-4 py-2 px-4 text-sm gap-2">
          <span className="size-2 rounded-full bg-emerald-500 animate-pulse" />
          Powered by Deep Logic Analysis
        </Badge>

        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-6 max-w-4xl bg-linear-to-b from-white to-white/40 bg-clip-text text-transparent">
